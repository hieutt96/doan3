<div class="row">
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="/<?php echo e($user_type); ?>/13">Kết quả đánh giá</a></li>
    </ul>
</div>
<div class="row">
    <div class="col-md-6">
        ...
        <p style="color: red"><i>Ở đây phải check kiểu user vì chỉ hiện form dưới cho gvhd, nhưng PM thì không.</i></p>
        <div class="row">
