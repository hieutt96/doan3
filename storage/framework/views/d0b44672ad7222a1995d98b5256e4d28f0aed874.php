<div class="row">
    <ul class="nav nav-tabs">
        <li role="presentation"><a href="/<?php echo e($user_type); ?>/sv/<?php echo e($student->user_id); ?>/thong-tin">Thông tin chi tiết</a></li>
        <li role="presentation" class="active"><a href="/<?php echo e($user_type); ?>/sv/<?php echo e($student->user_id); ?>/cong-viec">Công
                việc</a></li>
