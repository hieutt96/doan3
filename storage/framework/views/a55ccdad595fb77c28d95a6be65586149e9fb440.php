<div class="row">
    <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="/<?php echo e($user_type); ?>/sv/info/<?php echo e($student->id); ?>">Thông tin chi tiết</a></li>
...
<div class="row" style="padding-top: 10px">
    <div class="col-md-6">
        <div class="row">
            ...
            <div class="col-md-7">
                <ul class="list-group">
                    <li class="list-group-item">Họ tên: <b><?php echo e($student->hoTen); ?></b></li>
        ...
        <div class="row" style="padding-right: 15px">
            <ul class="list-group">
                <li class="list-group-item">Email: <b><?php echo e($student->email); ?></b></li>
                <li class="list-group-item">Địa chỉ đang ở: <b><?php echo e($student->diaChi); ?></b></li>
                <li class="list-group-item">Tài khoản: <b><?php echo e($student->email); ?></b></li>
    ...
    <div class="col-md-6">
        <div class="row">
            <ul class="list-group">
                ...
                <li class="list-group-item">Khả năng tiếng anh: <b><?php echo e($student->TA); ?></b></li>
