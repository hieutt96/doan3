        ...
        <div class="row" style="padding-top: 10px">
            <div class="col-md-4">
                <fieldset form="stuCheckForm" class="form-group form-inline">
                    <button id="phanCong" type="submit" form="stuCheckForm" class="btn btn-primary">Sửa phân công</button>
            ...
            <div class="col-md-3">
                <form action="/pm/da-phan-cong" method="get" role="search">
        ...
        <form class="form-inline" method="post" id="stuCheckForm" action="/pm/phan-cong">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('idNVPhuTrach', 'ID Leader'));?>
                        <div class="glyphicon glyphicon-triangle-bottom"></div>
                    </th>
                </tr>
                </thead>
