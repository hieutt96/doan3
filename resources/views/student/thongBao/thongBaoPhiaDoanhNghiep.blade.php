@extends('student.thongBao.thongBaoSinhVien') @section('thongbao')
<div class="col-md-9">
			...
			<div class="row-item row">
				...
				<div class="border-right">
					...
					<div class="col-md-10">
						<h3>{{$noti->tieu_de}}</h3>
						<p>
							<i style="color:#aaaaaa">Đăng bởi:{{$noti->name}}</i>
						</p>
						<a class="btn btn-primary" href="student/thong-bao-phia-doanh-nghiep/{{$noti->id}}">Chi tiết
	...
	{{--  @section('pagination') {{ $notice->links() }} @endsection  --}}
</div>
@endsection