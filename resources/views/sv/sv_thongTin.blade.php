<div class="row">
    <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="/{{$user_type}}/sv/{{$student->user_id}}/thong-tin">Thông tin
                chi tiết</a></li>
        <li role="presentation"><a href="/{{$user_type}}/sv/{{$student->user_id}}/cong-viec">Công việc</a></li>
