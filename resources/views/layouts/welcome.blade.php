		...
		<div class="collapse navbar-collapse" id="app-navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li style="margin-top: 16px;">
					<b data-toggle="modal" data-target="#register">Đăng ký</b>
				</li>
				<div class="modal fade col-lg-4 col-lg-offset-4" id="register" role="dialog" style="margin-top: 100px;">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<button type="button" class="btn btn-default" data-dismiss="modal" style="left: 5%;">Close
							</button>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li>
									<a tabindex="-1" href="{{ url('student/change-password') }}">Đổi mật khẩu</a>
									<li/>
									<li>
										<a href="{{ url('student/student-info') }}">Thông tin cá nhân</a>
										<li/>
										<li>
											<a href="{{ url('student/update-student-info') }}">Cập nhật thông tin cá nhân
											</a>
											<li/>
											<li class="divider"></li>
											<!--   <li>Hieu</li> -->
											<li>
												...
												@endif @if(Auth::User()->level == 3)
												<a href="">Truy Cập Trang Quản Lí</a>
												@endif @if(Auth::User()->level == 4)
												<a href="/admin-dashboard">Truy Cập Trang Quản Lí</a>
												@endif @if(Auth::User()->level == 5)
												<a href="/">Truy Cập Trang Quản Lí</a>
												@endif
												<a href="{{ route('dang-xuat') }}" onclick="event.preventDefault();
				...
				<nav class="navbar navbar-default">
					<div class="container-fluid">
						<ul class="nav navbar-nav">
							...
							<li>
								<a href="{{ url('hop-tac-doanh-nghiep') }}">Hợp tác doanh nghiệp</a>
							</li>
							@if(Auth::user())
							<li>
								<a href="{{ url('student/cong-viec-thuc-tap')}}">Công việc thực tập </a>
							</li>
							<li>
								<a href="{{ url('student/thong-bao-phia-nha-truong') }}">Thông báo</a>
							</li>
							@endif @if(Auth::guest())
							<li>
			...
			@yield('welcome') @yield('script')
			<footer>
				<div>
					<div class="row" style="background: #263c65; color:white;">
						<div class="col-lg-6 col-lg-offset-3" style="text-align: center;">
							<p style="padding-top:20px;">Bản quyền
								<span class="glyphicon glyphicon-copyright-mark"></span> thuộc về viện Công nghệ thông tin và truyền thông</p>
