					...
					<form method="POST" action="{{route('tao-lich-dang-ky-hoc-ky.post')}}">
						{{ csrf_field() }}
			      		<div class="modal-body">
				       		...
				       		<div class="row">
				       			Thời gian sinh viên bắt đầu đi thực tập:<input type="date" name="thoi_gian_sv_bat_dau_thuc_tap" required>
				       		</div><br>
				       		<div class="row">
				       			Thời gian sinh viên kết thúc thực tập:<input type="date" name="thoi_gian_sv_ket_thuc_thuc_tap" required>
				       		</div><br>
				       		<div>
